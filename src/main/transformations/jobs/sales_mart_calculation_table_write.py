...
def sales_mart_calculation_table_write(final_sales_team_data_mart_df):
    ...
    final_sales_team_data_mart_table = final_sales_team_data_mart\
            ...
            .select("store_id","sales_person_id","full_name","sales_month",col("total_sales_every_month").alias("total_sales"),col("incentive"))
#            .withColumn("sales_month",col("total_sales_every_month"))\
#            .select("store_id","sales_person_id","full_name","sales_month","total_sales","incentive")

    final_sales_team_data_mart_table.show()
    #Write the data into MySQL cutomer_data_mart table
